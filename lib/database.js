...
/**
  Loads a model for a particular brand
 **/
Database.prototype.getBrandModel = function(brand, modelName, callback) {
	return this.getModel(modelName, { namespace: brand.namespace }, callback);
}
